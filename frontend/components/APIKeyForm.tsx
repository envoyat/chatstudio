...
const ApiKeyField = ({ id, label, linkUrl, placeholder, models, error, required, register }: ApiKeyFieldProps) => (
  <div className="flex flex-col gap-2">
    ...
    <a href={linkUrl} target="_blank" className="text-sm text-blue-500 inline w-fit" rel="noreferrer">
